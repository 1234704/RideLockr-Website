    ...
    <section id="features" className="py-28 bg-[#050505] text-white px-6">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="text-center mb-20">
          ...
          >
            Advanced <span className="text-[#39FF14]">Features</span>
          </motion.h2>
          <p className="text-gray-500 text-xs md:text-sm mt-3 uppercase tracking-[0.3em] max-w-lg mx-auto font-medium">
            Cutting-edge hardware paired with intelligent software to keep your motorcycle unstealable.
          </p>
        </div>
          ...
          {featureList.map((feat, i) => (
            ...
            >
              ...
              <div className="lg:col-span-7 relative min-h-[250px] lg:min-h-full overflow-hidden bg-neutral-950">
                ...
                <div className={`absolute inset-0 bg-gradient-to-tr ${feat.accent} opacity-40 group-hover:opacity-100 transition-opacity duration-700 z-10 pointer-events-none`} />
